...
def init():
    ...
    half = device.type != False  # half precision only supported on CUDA

    model = attempt_load('best_yolov5s_bdd.pt', map_location=device)  # load FP32 model
...
if __name__ == '__main__':
    ...
    video_path = 'cb61fa6c-1104f84c.mov'
    save_path = 'data/video/videoResult1.mp4'
