...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default=r'C:\Users\violet\Desktop\42\twice\bdd100k_2\yolov5s_bdd100k-master\yolov5s_bdd100k-master\models\custom_yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=r'C:\Users\violet\Desktop\42\twice\bdd100k_2\yolov5s_bdd100k-master\yolov5s_bdd100k-master\data\traffic_data.yaml', help='data.yaml path')
